<template>
  <lgt-page type="picker-view" title="Picker" desc="">
    <div slot="content">
      <lgt-button-group>
        <lgt-button type="success" @click="showPicker">Picker</lgt-button>
        <lgt-button type="success" @click="showMutiPicker">Multi-column Picker</lgt-button>
        <lgt-button type="success" @click="showAliasPicker">Use alias</lgt-button>
        <lgt-button type="success" @click="showUpdatePropsPicker">Use $updateProps</lgt-button>
        <lgt-button type="success" @click="showSubtitlePicker">Use subtitle</lgt-button>
      </lgt-button-group>
    </div>
  </lgt-page>
</template>
